...
namespace HamsterAnviz
{
    class Win32
    {
        ...
        public static byte[] gpFeatureC = new byte[256];
        ...
        [DllImport("AvzScanner.dll")]
        public static extern UInt16 AvzProcess(byte[] pimagein, byte[] feature, byte[] pimagebin, byte bthin, byte bdrawfea, UInt16 comst);
        [DllImport("AvzScanner.dll")]
        public static extern UInt16 AvzProcess(IntPtr ptr, byte[] feature, byte[] pimagebin, byte bthin, byte bdrawfea);
        [DllImport("AvzScanner.dll")]
        ...
        [DllImport("AvzScanner.dll")]
        public static extern Int16 AvzMatchN(byte[] pFeature, byte[] gpFeatureLib, UInt16 FingerNum, UInt16 level);
    }
}
